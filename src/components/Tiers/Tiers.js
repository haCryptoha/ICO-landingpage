                ...
                <div className="tier-wrapper" data-aos="flip-up">
                    ...
                    <div className="tier-bdy bg-body-t">
                        <div className="tier-inner-wrap">
                            <div className="tier-head tier-body-h">
                                <span>
                                    Our genesis collection is an ERC721X implementation build on ERC721 protocol minting, further designed to be scalable and gas-efficient and it provides batch minting at a fixed gas cost which drastically reduces the NFT minting gas fees up to 80% over the traditional minting.
                                </span>
                            </div>
                        </div>
                    </div>
